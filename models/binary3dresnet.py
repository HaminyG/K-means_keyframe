...
class ResNet(nn.Module):
    def __init__(self, block, layers, shortcut_type, sample_size, sample_duration, attention=False):
...
def attentionresnet18(pretrained=False, **kwargs):
...
def attentionresnet34(pretrained=False, progress=True, **kwargs):
...
if __name__ == '__main__':
    ...
    cnn3d = attentionresnet18(pretrained=True,sample_size=sample_size, sample_duration=sample_duration, attention=False)
    print(cnn3d(data)[0])